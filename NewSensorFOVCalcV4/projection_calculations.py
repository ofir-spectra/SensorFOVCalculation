...
def find_optimal_angle_for_coverage(params, angle_range=(0, 65), angle_step=1):
    ...
    for angle in np.arange(angle_range[0], angle_range[1] + angle_step, angle_step):
        ...
        try:
            ...
            continue  # Skip problematic angles
    
    return best_angle, best_coverage

def calculate_water_coverage_curve(params, angle_range=(0, 60), angle_step=2):
