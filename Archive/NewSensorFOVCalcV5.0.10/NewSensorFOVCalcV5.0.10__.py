...
class ProjectionApp:
    ...
    def plot_projection(self):
        ...
        plot_data['pixels_x_naive'] = int(round(px_naive_ori))
        plot_data['pixels_y_naive'] = int(round(py_naive_ori))
        plot_data['pixels_x_sensor'] = int(round(px_sensor_ori))
        plot_data['pixels_y_sensor'] = int(round(py_sensor_ori))
        A = params['A']
        try:
